...
# Abnormal Source Configuration
if [ -d "/Users/tejesh/source" ]; then
    export SOURCE="/Users/tejesh/source"
...
#   gtr ls                       # list all worktrees
#   gtr claude feature0          # run `claude` while inside that worktree
#
gtr() {
    local cmd="$1"; shift || { echo "Usage: gtr {create|rm|cd|ls|claude} <name>"; return 1; }
